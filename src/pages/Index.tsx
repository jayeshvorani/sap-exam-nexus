      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          <h2 className="text-4xl font-light text-gray-900 mb-6">
            Professional SAP Exam Platform
          </h2>
        ...
        {/* Key Benefits */}
        <div className="mb-16">
          <h3 className="text-2xl font-semibold text-center text-gray-900 mb-8">Why Choose SAP Exam Nexus?</h3>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Real exam conditions with the same interface and timing as official SAP certifications</p>
            </div>
            <div className="text-center">
        ...
        <div className="text-center bg-gray-50 rounded-2xl p-8">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Join thousands of professionals who have successfully passed their SAP certifications using our platform.
          </p>
          <Button size="lg" onClick={() => setShowRegister(true)} className="text-lg px-8 py-3">
            Create Your Account
          </Button>
