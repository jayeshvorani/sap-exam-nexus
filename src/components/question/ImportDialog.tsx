        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-950/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
            ...
            <div className="text-sm text-blue-700 dark:text-blue-300 mb-3 space-y-2">
              ...
              <div className="bg-blue-100 dark:bg-blue-900/30 p-2 rounded text-xs border border-blue-200 dark:border-blue-700">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4 text-sm">
                <div className="bg-muted p-3 rounded border">
                  ...
                  <div className="text-lg text-foreground">{importResult.totalRows}</div>
                </div>
              ...
              {importResult.validQuestions.length > 0 && (
                <div>
                  <h5 className="font-medium mb-2 text-foreground">Questions to Import ({importResult.validQuestions.length})</h5>
                  <div className="bg-muted p-3 rounded border max-h-40 overflow-y-auto text-sm">
