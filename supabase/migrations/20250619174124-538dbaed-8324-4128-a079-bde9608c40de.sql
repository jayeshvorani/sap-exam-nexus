...
-- Drop the current view and recreate it with logic that works with actual data
DROP VIEW IF EXISTS public.user_exam_statistics;

-- Create a view that determines completion based on end_time and score rather than is_completed flag
